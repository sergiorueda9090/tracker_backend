...
from finalizados.websocket.routing import websocket_urlpatterns as finalizados_ws_urls
from archivadas.websocket.routing import websocket_urlpatterns as archivadas_ws_urls
...
] + preparacion_ws_urls + user_ws_urls + tracker_ws_urls + finalizados_ws_urls + archivadas_ws_urls
